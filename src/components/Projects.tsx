...
const projects = [
    {
        title: "Data Engineering Layer for Telemetry Federation",
        organization: "UTS",
        role: "PhD Research Project",
        description: "A data engineering solution for federating telemetry data, enabling efficient data collection, processing, and analysis across distributed systems.",
        technologies: ["Data Engineering", "Telemetry", "Federation", "Distributed Systems"],
        github: "https://github.com/gracebilliris/data-engineering-layer-for-telemetry-federation",
        links: {
            demo: "https://www.youtube.com/watch?v=uWY3sr18-9g"
        }
    },
    {
        title: "Privacy Anonymisation Risk Assessor (PARA)",
        organization: "UTS",
        role: "PhD Research Project",
    description: "A tool for assessing privacy risks in data anonymisation processes, helping organisations evaluate and improve their data privacy measures.",
        technologies: ["Privacy", "Risk Assessment", "Data Anonymisation", "Security"],
        github: "https://github.com/gracebilliris/para-privacy-anonymisation-risk-assessor",
        links: {
            demo: "https://youtu.be/qGkDELNTh8M"
        }
    },
    {
        title: "VERSA (Versatile Extensible Risk and Security Assessor)",
        organization: "UTS",
        role: "PhD Research Project",
        description: "A versatile and extensible tool for assessing security risks across various domains, providing comprehensive security evaluation capabilities.",
        technologies: ["Security", "Risk Assessment", "Extensible Architecture"],
        github: "https://github.com/gracebilliris/VERSA"
    },
    {
        title: "AIPRATool: AI Privacy Risk Assessment Tool",
        organization: "UTS",
        role: "PhD Research Project",
    description: "A specialized tool for assessing privacy risks in AI systems, helping developers and organisations ensure compliance with privacy standards.",
        technologies: ["AI", "Privacy", "Risk Assessment", "Compliance"],
        github: "https://github.com/gracebilliris/AIPRATool",
        links: {
            tool: "https://tally.so/r/npMbGB",
            demo: "https://youtu.be/4b8rg6NQ5bs"
        }
    },
    {
        title: "Say Find - Interactive Party Game",
        organization: "Personal",
        role: "Creator",
        description: "A fun, fully interactive team-based quiz game combining knowledge, wit, and competition. Features team management, flexible game setup, real-time scoring, and the ability to share victories. Built with vanilla HTML, CSS, and JavaScript and deployed as a static GitHub Pages site.",
        technologies: ["HTML", "CSS", "JavaScript", "GitHub Pages", "Party Game"],
        github: "https://github.com/gracebilliris/say-find",
        links: {
            demo: "https://gracebilliris.github.io/say-find/"
        }
    },
    {
    ...
    },
    {
        ...
        github: "https://github.com/SIS-Team-24/2023-SIS-Team-24",
    },
    {
                        ...
                        >
                            <div className="p-6">
                                <div className="flex items-start justify-between mb-2">
                                    <h3 className="text-xl font-semibold text-textLight">{project.title}</h3>
                                </div>
                                <div className="mb-2">
                                ...
                                {project.longDescription && <p className="text-text mb-4">{project.longDescription}</p>}
